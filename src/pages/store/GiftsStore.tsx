...
import { ShoppingBag, ArrowLeft, Heart, Gift, Search } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background" dir="rtl" style={{ fontFamily: "'Inter', sans-serif" }}>
      <nav className="sticky top-0 z-50 backdrop-blur-xl bg-background/80 border-b border-border">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-bold text-foreground">{settings?.hero_title || "هدايا ستور"}</h1>
          </div>
      ...
      <motion.section initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8 }} className="relative h-[60vh] overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `url(${settings?.hero_image_url || "https://images.unsplash.com/photo-1513201099705-a9746e1e201f?w=1600&q=80"})` }} />
