...
const Dashboard = () => {
  ...
  // Check if organization is disabled (not pending - pending now goes to dashboard with limited access)
  if (role === "admin" && organization && !organization.is_active && organization.approval_status !== "pending") {
